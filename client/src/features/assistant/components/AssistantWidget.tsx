...
export function AssistantWidget() {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      // Use anon key if no session (for now, since auth isn't fully implemented)
      ...
      const errorMessage: Message = {
        ...
        content: error instanceof Error 
          ? `Sorry, I encountered an error: ${error.message}. Please check your API keys in Supabase secrets (GOOGLE_AI_API_KEY or OPENAI_API_KEY) and try again.`
